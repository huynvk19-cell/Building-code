...
phan: "Phụ lục H"
tieu_de: "Bậc chịu lửa và các yêu cầu bảo đảm an toàn cháy cho nhà, công trình, khoang cháy"
tinh_chat: "Quy định (bắt buộc áp dụng)"
ban_hanh_kem_theo: "QCVN 06:2022/BXD"
ngay_hieu_luc: "2023-01-16"
lien_quan_muc: ["2.5.3.2", "4.2", "A.1.3.3", "E.1 CHÚ THÍCH 5", "E.1 CHÚ THÍCH 6", "E.2 CHÚ THÍCH 2 a)"]
chia_theo: "H."
ngon_ngu: "vi"
---
...
> **CÁCH DÙNG:** Đây là phụ lục để tra **số tầng (chiều cao PCCC) cho phép** và
> **diện tích lớn nhất cho phép của một tầng trong phạm vi một khoang cháy**,
> theo bậc chịu lửa và cấp nguy hiểm cháy kết cấu đã chọn. Được viện dẫn tại
> 2.5.3.2 và 4.2 của phần chính.
...
| **C** *(xem ^2)^)* | 48 | I, II | S0 | Không hạn chế | 25 000<br>7 800 ^3)^ | 10 400<br>5 200 ^3)^ |
